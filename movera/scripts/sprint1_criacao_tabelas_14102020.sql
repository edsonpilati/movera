...
CREATE TABLE public.UND (
                ...
                NR_HH_UND NUMERIC(2) DEFAULT 00 NOT NULL,
...
COMMENT ON COLUMN public.UND.NR_HH_UND IS 'Número de Horas a acrescentar ou diminuir da unidade em relação a Brasília';
